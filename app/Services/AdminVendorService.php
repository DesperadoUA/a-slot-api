...
class AdminVendorService extends BaseService {
    ...
    public function store($data) {
        $data_save = self::dataCommonValidateInsert($data, $this->tables['VENDOR'], $this->tables['VENDOR_META']);
    ...
    public function update($data) {
        $data_save = self::dataValidateSavePosts($data['id'], $data, $this->tables['POKER'], $this->tables['VENDOR_META']);
        $post = new Posts(['table' => $this->tables['VENDOR'], 'table_meta' => $this->tables['VENDOR_META']]);
