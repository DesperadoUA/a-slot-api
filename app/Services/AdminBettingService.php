...
class AdminBettingService extends BaseService {
    const SLUG = 'betting';
    ...
    public function adminIndex($settings) {
        $posts = new Posts(['table' => $this->tables['BETTING'], 'table_meta' => $this->tables['BETTING_META']]);
    ...
    public function store($data) {
        $data_save = self::dataCommonValidateInsert($data, $this->tables['BETTING'], $this->tables['BETTING_META']);
    ...
    public function update($data) {
        $data_save = self::dataValidateSavePosts($data['id'], $data, $this->tables['BETTING'], $this->tables['BETTING_META']);
        $post = new Posts(['table' => $this->tables['BETTING'], 'table_meta' => $this->tables['BETTING_META']]);
